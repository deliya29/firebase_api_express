...
admin.initializeApp({
  ...
  databaseURL: 'https://fir-restapi-3d6dc-default-rtdb.firebaseio.com'
});
...
app.post('/register', async (req, res) => {
  ...
  try {
    ...
    const response = await fetch(
      `https://identitytoolkit.googleapis.com/v1/accounts:signInWithCustomToken?key=AIzaSyAAjLkHDZv4qaE0DdmK6UgBI2mPoM8zZvM`,
      {
        method: 'POST',
